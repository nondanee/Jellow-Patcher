...
.field private final f:Lio/fabric/sdk/android/m/b/s;
...
.method constructor <init>(Landroid/content/Context;Ljava/util/Map;Lio/fabric/sdk/android/services/concurrency/k;Landroid/os/Handler;Lio/fabric/sdk/android/k;ZLio/fabric/sdk/android/f;Lio/fabric/sdk/android/m/b/s;Landroid/app/Activity;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 10
    iput-object p8, p0, Lio/fabric/sdk/android/c;->f:Lio/fabric/sdk/android/m/b/s;
...
.method private static a(Ljava/util/Map;Ljava/util/Collection;)V
    ...
    invoke-interface {v0}, Lio/fabric/sdk/android/i;->a()Ljava/util/Collection;
...
.method a(Ljava/util/Map;Lio/fabric/sdk/android/h;)V
    ...
    .line 12
    iget-object v0, p2, Lio/fabric/sdk/android/h;->k:Lio/fabric/sdk/android/services/concurrency/d;

    if-eqz v0, :cond_4

    .line 13
    invoke-interface {v0}, Lio/fabric/sdk/android/services/concurrency/d;->value()[Ljava/lang/Class;
    ...
    invoke-virtual {v6, v5}, Lio/fabric/sdk/android/services/concurrency/f;->a(Lio/fabric/sdk/android/services/concurrency/l;)V
    ...
    invoke-virtual {v4, v3}, Lio/fabric/sdk/android/services/concurrency/f;->a(Lio/fabric/sdk/android/services/concurrency/l;)V
...
.method b(Landroid/content/Context;)V
    ...
    iget-object v3, p0, Lio/fabric/sdk/android/c;->f:Lio/fabric/sdk/android/m/b/s;

    invoke-virtual {v2, p1, p0, v1, v3}, Lio/fabric/sdk/android/h;->a(Landroid/content/Context;Lio/fabric/sdk/android/c;Lio/fabric/sdk/android/f;Lio/fabric/sdk/android/m/b/s;)V
    ...
    iget-object v5, p0, Lio/fabric/sdk/android/c;->f:Lio/fabric/sdk/android/m/b/s;

    invoke-virtual {v3, p1, p0, v4, v5}, Lio/fabric/sdk/android/h;->a(Landroid/content/Context;Lio/fabric/sdk/android/c;Lio/fabric/sdk/android/f;Lio/fabric/sdk/android/m/b/s;)V

    goto :goto_0

    .line 10
    :cond_0
    invoke-virtual {v2}, Lio/fabric/sdk/android/h;->o()V
    ...
    invoke-virtual {v5, v6}, Lio/fabric/sdk/android/services/concurrency/f;->a(Lio/fabric/sdk/android/services/concurrency/l;)V
    ...
    .line 20
    invoke-virtual {v4}, Lio/fabric/sdk/android/h;->o()V
    ...
    .line 23
    invoke-virtual {v4}, Lio/fabric/sdk/android/h;->m()Ljava/lang/String;
