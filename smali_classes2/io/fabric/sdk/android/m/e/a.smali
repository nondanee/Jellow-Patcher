.class abstract Lio/fabric/sdk/android/m/e/a;
.super Lio/fabric/sdk/android/m/b/a;
...
.method public constructor <init>(Lio/fabric/sdk/android/h;Ljava/lang/String;Ljava/lang/String;Lio/fabric/sdk/android/services/network/d;Lio/fabric/sdk/android/services/network/c;)V
    ...
    .line 1
    invoke-direct/range {p0 .. p5}, Lio/fabric/sdk/android/m/b/a;-><init>(Lio/fabric/sdk/android/h;Ljava/lang/String;Ljava/lang/String;Lio/fabric/sdk/android/services/network/d;Lio/fabric/sdk/android/services/network/c;)V

    return-void
.end method

.method private a(Lio/fabric/sdk/android/services/network/HttpRequest;Lio/fabric/sdk/android/m/e/d;)Lio/fabric/sdk/android/services/network/HttpRequest;
    .locals 1

    .line 15
    iget-object p2, p2, Lio/fabric/sdk/android/m/e/d;->a:Ljava/lang/String;
    ...
    iget-object p2, p0, Lio/fabric/sdk/android/m/b/a;->e:Lio/fabric/sdk/android/h;

    .line 17
    invoke-virtual {p2}, Lio/fabric/sdk/android/h;->m()Ljava/lang/String;
...
.method private b(Lio/fabric/sdk/android/services/network/HttpRequest;Lio/fabric/sdk/android/m/e/d;)Lio/fabric/sdk/android/services/network/HttpRequest;
    .locals 7

    const-string v0, "Failed to close app icon InputStream."

    .line 1
    iget-object v1, p2, Lio/fabric/sdk/android/m/e/d;->b:Ljava/lang/String;
    ...
    iget-object v1, p2, Lio/fabric/sdk/android/m/e/d;->f:Ljava/lang/String;
    ...
    iget-object v1, p2, Lio/fabric/sdk/android/m/e/d;->c:Ljava/lang/String;
    ...
    iget-object v1, p2, Lio/fabric/sdk/android/m/e/d;->d:Ljava/lang/String;
    ...
    iget v1, p2, Lio/fabric/sdk/android/m/e/d;->g:I
    ...
    iget-object v1, p2, Lio/fabric/sdk/android/m/e/d;->h:Ljava/lang/String;
    ...
    iget-object v1, p2, Lio/fabric/sdk/android/m/e/d;->i:Ljava/lang/String;
    ...
    .line 8
    iget-object v1, p2, Lio/fabric/sdk/android/m/e/d;->e:Ljava/lang/String;

    invoke-static {v1}, Lio/fabric/sdk/android/m/b/i;->b(Ljava/lang/String;)Z
    ...
    .line 10
    :cond_0
    iget-object v1, p2, Lio/fabric/sdk/android/m/e/d;->j:Lio/fabric/sdk/android/m/e/n;
    ...
    .line 11
    :try_start_0
    iget-object v2, p0, Lio/fabric/sdk/android/m/b/a;->e:Lio/fabric/sdk/android/h;
    ...
    iget-object v3, p2, Lio/fabric/sdk/android/m/e/d;->j:Lio/fabric/sdk/android/m/e/n;

    iget v3, v3, Lio/fabric/sdk/android/m/e/n;->b:I
    ...
    iget-object v3, v3, Lio/fabric/sdk/android/m/e/n;->a:Ljava/lang/String;
    ...
    iget v3, v3, Lio/fabric/sdk/android/m/e/n;->c:I
    ...
    iget v3, v3, Lio/fabric/sdk/android/m/e/n;->d:I
    ...
    iget-object v6, p2, Lio/fabric/sdk/android/m/e/d;->j:Lio/fabric/sdk/android/m/e/n;

    iget v6, v6, Lio/fabric/sdk/android/m/e/n;->b:I
    ...
    :cond_1
    :goto_2
    iget-object p2, p2, Lio/fabric/sdk/android/m/e/d;->k:Ljava/util/Collection;
    ...
    .line 21
    invoke-virtual {p0, v0}, Lio/fabric/sdk/android/m/e/a;->b(Lio/fabric/sdk/android/j;)Ljava/lang/String;
    ...
    .line 22
    invoke-virtual {p0, v0}, Lio/fabric/sdk/android/m/e/a;->a(Lio/fabric/sdk/android/j;)Ljava/lang/String;
...
.method public a(Lio/fabric/sdk/android/m/e/d;)Z
    .locals 5

    .line 1
    invoke-virtual {p0}, Lio/fabric/sdk/android/m/b/a;->a()Lio/fabric/sdk/android/services/network/HttpRequest;

    move-result-object v0

    .line 2
    invoke-direct {p0, v0, p1}, Lio/fabric/sdk/android/m/e/a;->a(Lio/fabric/sdk/android/services/network/HttpRequest;Lio/fabric/sdk/android/m/e/d;)Lio/fabric/sdk/android/services/network/HttpRequest;

    .line 3
    invoke-direct {p0, v0, p1}, Lio/fabric/sdk/android/m/e/a;->b(Lio/fabric/sdk/android/services/network/HttpRequest;Lio/fabric/sdk/android/m/e/d;)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    invoke-virtual {p0}, Lio/fabric/sdk/android/m/b/a;->b()Ljava/lang/String;
    ...
    .line 5
    iget-object v1, p1, Lio/fabric/sdk/android/m/e/d;->j:Lio/fabric/sdk/android/m/e/n;
    ...
    iget-object v4, p1, Lio/fabric/sdk/android/m/e/d;->j:Lio/fabric/sdk/android/m/e/n;

    iget-object v4, v4, Lio/fabric/sdk/android/m/e/n;->a:Ljava/lang/String;
    ...
    iget v4, v4, Lio/fabric/sdk/android/m/e/n;->c:I
    ...
    iget-object p1, p1, Lio/fabric/sdk/android/m/e/d;->j:Lio/fabric/sdk/android/m/e/n;

    iget p1, p1, Lio/fabric/sdk/android/m/e/n;->d:I
    ...
    .line 14
    invoke-static {p1}, Lio/fabric/sdk/android/m/b/v;->a(I)I
