...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/greenrobot/eventbus/o;->d:Ljava/util/Map;
...
.method private a(Lorg/greenrobot/eventbus/o$a;)V
    .locals 14
    ...
    .line 15
    :try_start_0
    iget-object v1, p1, Lorg/greenrobot/eventbus/o$a;->e:Ljava/lang/Class;
    ...
    .line 17
    iput-boolean v0, p1, Lorg/greenrobot/eventbus/o$a;->f:Z
...
.method private b(Ljava/lang/Class;)Ljava/util/List;
    ...
    .line 3
    :goto_0
    iget-object p1, v0, Lorg/greenrobot/eventbus/o$a;->e:Ljava/lang/Class;

    if-eqz p1, :cond_3

    .line 4
    invoke-direct {p0, v0}, Lorg/greenrobot/eventbus/o;->c(Lorg/greenrobot/eventbus/o$a;)Lorg/greenrobot/eventbus/q/c;

    move-result-object p1

    iput-object p1, v0, Lorg/greenrobot/eventbus/o$a;->g:Lorg/greenrobot/eventbus/q/c;

    if-eqz p1, :cond_1

    .line 5
    invoke-interface {p1}, Lorg/greenrobot/eventbus/q/c;->a()[Lorg/greenrobot/eventbus/n;
    ...
    .line 9
    :cond_1
    invoke-direct {p0, v0}, Lorg/greenrobot/eventbus/o;->a(Lorg/greenrobot/eventbus/o$a;)V
    ...
    .line 11
    :cond_3
    invoke-direct {p0, v0}, Lorg/greenrobot/eventbus/o;->b(Lorg/greenrobot/eventbus/o$a;)Ljava/util/List;
...
.method private b(Lorg/greenrobot/eventbus/o$a;)Ljava/util/List;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 13
    invoke-virtual {p1}, Lorg/greenrobot/eventbus/o$a;->b()V
...
.method private c(Lorg/greenrobot/eventbus/o$a;)Lorg/greenrobot/eventbus/q/c;
    .locals 3

    .line 1
    iget-object v0, p1, Lorg/greenrobot/eventbus/o$a;->g:Lorg/greenrobot/eventbus/q/c;

    if-eqz v0, :cond_0

    invoke-interface {v0}, Lorg/greenrobot/eventbus/q/c;->b()Lorg/greenrobot/eventbus/q/c;
    ...
    invoke-interface {v0}, Lorg/greenrobot/eventbus/q/c;->c()Ljava/lang/Class;
    ...
    check-cast v1, Lorg/greenrobot/eventbus/q/d;

    .line 6
    iget-object v2, p1, Lorg/greenrobot/eventbus/o$a;->e:Ljava/lang/Class;

    invoke-interface {v1, v2}, Lorg/greenrobot/eventbus/q/d;->a(Ljava/lang/Class;)Lorg/greenrobot/eventbus/q/c;
...
.method a(Ljava/lang/Class;)Ljava/util/List;
    ...
    .line 1
    sget-object v0, Lorg/greenrobot/eventbus/o;->d:Ljava/util/Map;
    ...
    .line 6
    sget-object v1, Lorg/greenrobot/eventbus/o;->d:Ljava/util/Map;
